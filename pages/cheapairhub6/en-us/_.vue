                  ...
                  <div class="flight_data row">
                    ...
                    >
                      ...
                      <div style="display:flex;align-items:center">
                        ...
                        />
                        <p style="font-size:25px;padding: 7px 15px;line-height:25px;height:25px">1877-593-2194</p>
                      </div>
                      <a
                        class="btn"
...
console.log('rtnsssssssssssssssssssssssss')
      ...
      var rtn = "Oneway"
        if(this.picked == 'roundtrip'){
            rtn = "Return"
         window.location.href = "/cheapairhub6/en-us/?SearchType="+ rtn + "&OriginStation="+ $("#from_iata").val().toUpperCase()  +"&DestinationStation="+ $("#to_iata").val().toUpperCase() +"&DepartureDate="+ newstring1 +"&ReturnDate="+ newstring2 +"&Adults="+ $(".drop-down1 .selected .value").html() +"&Children="+ $(".drop-down2 .selected .value").html() +"&Infants="+ $(".drop-down3 .selected .value").html() +"&cabinclass=" + $(".drop-down .selected .value").html().toLowerCase()
        }else{
          
          window.location.href = "/cheapairhub6/en-us/?SearchType="+ rtn + "&OriginStation="+ $("#from_iata").val().toUpperCase()  +"&DestinationStation="+ $("#to_iata").val().toUpperCase() +"&DepartureDate="+ newstring1 +"&Adults="+ $(".drop-down1 .selected .value").html() +"&Children="+ $(".drop-down2 .selected .value").html() +"&Infants="+ $(".drop-down3 .selected .value").html() +"&cabinclass=" + $(".drop-down .selected .value").html().toLowerCase()
        }
